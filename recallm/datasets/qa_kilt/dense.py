...
from recallm.datasets.qa_kilt.planning import initial_retrieval_k
...
def load_dense_corpus(
    ...
    *,
    ...
    if corpus_name == "hotpotqa_paragraphs":
        ...
        from recallm.datasets.qa_kilt.load_hotpotqa import get_hotpotqa
    ...
    if corpus_name == "musique_paragraphs":
        from recallm.datasets.qa_kilt.musique import _get_musique_datasets
    ...
    if corpus_name == "2wikimultihopqa_paragraphs":
        from recallm.datasets.qa_kilt.wiki_multi_hop import _get_two_wiki_datasets
