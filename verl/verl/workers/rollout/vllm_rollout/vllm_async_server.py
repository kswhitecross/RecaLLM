...
class vLLMHttpServer:
    ...
    async def launch_server(self, master_address: str = None, master_port: int = None, dp_rpc_port: int = None):
        ...
        # Extract hf_overrides from engine_kwargs so they can be merged with
        # internally-built hf_overrides (e.g. quantization config) instead of
        # being silently overwritten by the **engine_kwargs spread below.
        engine_kwargs_hf_overrides = engine_kwargs.pop("hf_overrides", {})
        ...
        # Merge user-supplied hf_overrides from engine_kwargs config
        hf_overrides.update(engine_kwargs_hf_overrides)
